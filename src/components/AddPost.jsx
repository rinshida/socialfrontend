...
const AddPost = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      const response = await axios.post("https://socialbackend-gxmb.onrender.com/api/addpost", { caption, discription, images: files},{
  ...
  return (
    <div className=' w-screen h-[570px] flex flex-col items-center justify-center gap-3 bg-gradient-to-b from-blue-950 to-blue-800'>
