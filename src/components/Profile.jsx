...
const Profile = () => {
  ...
  return (
    <div className=' flex flex-col gap-[30px] w-full  bg-blue-950 py-[30px] pl-[60px] pr-[120px] box-border'>
       ...
       <div className=' flex flex-col gap-1 border-b border-b-white p-[10px] w-full'><div className=' w-full flex gap-[200px] '>
            ...
            return( 
                <div   className=' w-[250px] h-[330px] flex flex-col gap-2 overflow-hidden border rounded-xl border-white  bg-white p-5' key={j}>
                              <div className=' flex justify-between items-center h-[20px] '><div className=' flex gap-2 items-center h-[20px] '>
                                ...
                                <button className=' border border-blue-950 text-blue-950 font-bold p-2'>follow</button></div>
